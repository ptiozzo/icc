...
$loopMappaSiciliaSlider = new WP_Query( $argsMappaSiciliaSlider );

if ($loopMappaSiciliaSlider->have_posts()) {
  $loopMappaSiciliaSlider->the_post();
  ...
  <div class='head'>
    <div class='title'>
      <h5>LA MAPPA DELLA SICILIA CHE CAMBIA</h5>
    </div>
  </div>
  ...
  <div id="carouselMappa" class="carousel carousel-control-top slide" data-ride="carousel" data-interval="5000">
    <div class="slider-top bg-dark d-flex flex-row align-items-center justify-content-between mb-2">
      ...
      <ol class="carousel-indicators pr-2 text-white">
        ...
        <?php
        $i = 1;
        while ($loopMappaSiciliaSlider->have_posts()) {
          $loopMappaSiciliaSlider->the_post();
          ?>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <article>
            <figure>
              <a href="<?php echo home_url(); ?>/sicilia/mappa/"><img class="img-fluid minatura-sicilia" src='<?php echo get_template_directory_uri();?>/assets/img/modules/sicilia/sicilia-mappa.png' alt='' title=''></a>
            </figure>
        </article>
      </div>
