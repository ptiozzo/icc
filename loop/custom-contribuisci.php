<div class="row contribuisci collapse <?php if($_COOKIE['contribuisci']!= 'close2'){echo "show";} ?> mx-0" id="contribuisci">
  ...
  <div class="col-auto d-flex align-items-end"><a class="btn btn-dark mb-3 text-white" href="/sostienici/">Contribuisci</a></div>
  <div class="col-auto"><button class="btn btn-dark mt-md-1 text-black" type="button" data-toggle="collapse" data-target="#contribuisci" aria-expanded="false" aria-controls="collapsContribuisci">X</a></div>
</div>
<script>
