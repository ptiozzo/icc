...
if( $loopICCTVSticky->have_posts()){
  while($loopICCTVSticky->have_posts()){
    ...
    $exclude_posts_ICCTV_sticky_mobile[] = $post->ID;
  }
}
...
if( $loopICCTV->have_posts() || $loopICCTVSticky->have_posts() ) : ?>
  ...
  <div id="carouselLeNostreStorieMobile" class="carousel carousel-control-top slide" data-ride="carousel" data-interval="false">
    <div class="slider-top bg-dark d-flex flex-row align-items-center justify-content-between mb-2">
      <a class="carousel-control-prev" href="#carouselLeNostreStorieMobile" data-no-swup role="button" data-slide="prev">
      ...
      <a class="carousel-control-next" href="#carouselLeNostreStorieMobile" data-no-swup role="button" data-slide="next">
