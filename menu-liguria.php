<header class="menu_regioni">
  ...
  <nav class="navbar navbar-dark navbar-expand-xl">
   ...
   ?>
   <button type="button" class="btn btn-outline-dark border-0 mr-2 text-white" data-toggle="modal" data-target="#LiguriaAccedi">
...
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <iframe src="https://api.pianetafuturo.it/widget/account/ext_login.php?a=8" height="300px" width="100%"></iframe>
    </div>
...
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <iframe src="https://api.pianetafuturo.it/widget/account/ext_register.php?a=8" height="400px" width="100%"></iframe>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    </div>
