...
function banner_pianetafuturo() {
            ...
            if (in_category('piemonte-che-cambia')){
              $ad_code .= "<div class='d-flex flex-column flex-md-row justify-content-center align-items-center'><img class='img-fluid'  src='". get_template_directory_uri() ."/assets/img/modules/pianetafuturo/pfuturo_logo_grigio_32.png' title='' alt=''><p class='single__pianetafuturo2 pl-2 my-0'>pianeta<b>futuro</b></p>";
