...
function myplugin_rewrite_rule() {
  ...
  add_rewrite_rule( '^piemonte/articoli/page/?([0-9]{1,})/?', 'index.php?page_id=41188&paged=$matches[1]','top' );
	...
	add_rewrite_rule( '^piemonte/visione-2040-cuneo/agricoltura-e-alimentazione/?', 'index.php?page_id=93360','top' );
	add_rewrite_rule( '^piemonte/visione-2040-cuneo/ambiente-e-verde/?', 'index.php?page_id=93363','top' );
	add_rewrite_rule( '^piemonte/visione-2040-cuneo/comunita/?', 'index.php?page_id=93366','top' );
	add_rewrite_rule( '^piemonte/visione-2040-cuneo/?', 'index.php?page_id=93357','top' );
