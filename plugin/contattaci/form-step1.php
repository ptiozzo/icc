...
<form id="form_contattaci_step1" class="form-inline mb-4" action="<?php echo get_pagenum_link(); ?>" method="post">
  ...
  <input id="submit" type="submit" name="submit_step1" value="Continua" class="mt-3 btn btn-primary" disabled>
...
function sonounjs() {
  ...
  switch(e){
    ...
    case 'azienda-imprenditore-liberoprofessionista':
      var array = ["--Seleziona--","Sponsorizzare la mia attività su ICC","Promuovere un evento o un’iniziativa","Fare una donazione a ICC","Proporre una collaborazione di altro tipo", "Altro"];
    break;
    case 'lettore':
    ...
    break;
    case 'realta-mappa':
      var array = ["--Seleziona--", "Per la mappa di ICC", "Chiedere una modifica alla mia scheda sulla mappa di ICC","Segnalare una notizia o un progetto alla redazione","Segnalare un evento o un’iniziativa", "Fare una donazione a ICC", "Altro"];
    break;
    case 'associazione':
