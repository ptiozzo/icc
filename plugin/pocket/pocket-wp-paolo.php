<?php
/**
 * Plugin Name: Pocket WP Modified by Paolo
          ...
          if ($item['has_image'] != 0){
            ...
            $pwp_image = "";
		    	...
		    	array_push($pwp_links_output,
		    		array($pwp_url, $pwp_title, $pwp_excerpt, $pwp_image, $pwp_tags)
		    	);
		    }
	...
	public function widget( $args, $instance ) {
		...
		if(is_array($pwp_items)){
			...
			if($instance['credit'] == 'yes') {
				...
				echo '<span id="pwp_plugin_credit_widget"><a href="https://ptiozzo.net" target="_blank">Pocket WP</a> by <a href="https://twitter.com/ptiozzo" target="_blank">@ciaransm</a></span>';
			} else {
