...
if ( ! function_exists( 'icc_sidebars' ) ) {
	function icc_sidebars()	{
		register_sidebar(array( 'name' => esc_html__( 'Primary', 'icc' ),'id' => 'primary','description' => esc_html__( 'Sidebar homepage', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		...
		register_sidebar(array( 'name' => esc_html__( 'Home colonna destra', 'icc' ),'id' => 'homedx','description' => esc_html__( 'Area nella colonna centrale dopo 2 articoli, larghezza max 991', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		...
		register_sidebar(array( 'name' => esc_html__( 'Single piemonte fine articolo', 'icc' ),'id' => 'singlepiemonteend','description' => esc_html__( 'Area a fine singolo articolo piemonte, larghezza max 768', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s my-3">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Single casentino fine articolo', 'icc' ),'id' => 'singlecasentinoend','description' => esc_html__( 'Area a fine singolo articolo casentino, larghezza max 768', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s my-3">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Single liguria fine articolo', 'icc' ),'id' => 'singleliguriaend','description' => esc_html__( 'Area a fine singolo articolo liguria, larghezza max 768', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s my-3">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		...
		register_sidebar(array( 'name' => esc_html__( 'Home piemonte destra', 'icc' ),'id' => 'homepiemontedx','description' => esc_html__( 'Area piemonte nella colonna centrale dopo 2 articoli, larghezza max 991', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		...
		register_sidebar(array( 'name' => esc_html__( 'Home casentino destra', 'icc' ),'id' => 'homecasentinodx','description' => esc_html__( 'Area casentino nella colonna centrale dopo 2 articoli, larghezza max 991', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	}
}
