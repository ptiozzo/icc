...
if ( ! function_exists( 'icc_sidebars' ) ) {
	function icc_sidebars()	{
		...
		register_sidebar(array( 'name' => esc_html__( 'Home colonna centrale', 'icc' ),'id' => 'homedx','description' => esc_html__( 'Area nella colonna centrale dopo 2 articoli, larghezza max 991', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		...
		register_sidebar(array( 'name' => esc_html__( 'Home piemonte centrale', 'icc' ),'id' => 'homepiemontedx','description' => esc_html__( 'Area piemonte nella colonna centrale dopo 2 articoli, larghezza max 991', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		...
		register_sidebar(array( 'name' => esc_html__( 'Home casentino centrale', 'icc' ),'id' => 'homecasentinodx','description' => esc_html__( 'Area casentino nella colonna centrale dopo 2 articoli, larghezza max 991', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
