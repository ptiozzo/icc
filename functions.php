...
if ( ! function_exists( 'icc_sidebars' ) ) {
	function icc_sidebars()	{
		...
		register_sidebar(array( 'name' => esc_html__( 'Footer1', 'icc' ),'id' => 'footer1','description' => esc_html__( 'Area nel footer sotto a logo e menù a sinistra', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Footer2', 'icc' ),'id' => 'footer2','description' => esc_html__( 'Area nel footer sotto a logo e menù a destra', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		//register_sidebar(array( 'name' => esc_html__( 'Testata Sinistra', 'icc' ),'id' => 'testatasx','description' => esc_html__( 'Area nel header a sinistra, larghezza max 700px', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		//register_sidebar(array( 'name' => esc_html__( 'Testata Destra', 'icc' ),'id' => 'testatadx','description' => esc_html__( 'Area nel header a destra, larghezza max 700px', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Home colonna sinistra', 'icc' ),'id' => 'homesx','description' => esc_html__( 'Area nella colonna di sinistra tra evidenza e mappa', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Home colonna destra', 'icc' ),'id' => 'homedx','description' => esc_html__( 'Area nella colonna di destra dopoo 2 articoli', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Single inizio articolo', 'icc' ),'id' => 'singlestart','description' => esc_html__( 'Area ad inizio singolo articolo', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Single fine articolo', 'icc' ),'id' => 'singleend','description' => esc_html__( 'Area a fine singolo articolo', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Home piemonte sinistra', 'icc' ),'id' => 'homepiemontesx','description' => esc_html__( 'Area piemonte nella colonna di sinistra tra evidenza e mappa', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Home piemonte destra', 'icc' ),'id' => 'homepiemontedx','description' => esc_html__( 'Area piemonte nella colonna di destra dopo 2 articoli', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Home casentino sinistra', 'icc' ),'id' => 'homecasentinosx','description' => esc_html__( 'Area casentino nella colonna di sinistra tra evidenza e mappa', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
		register_sidebar(array( 'name' => esc_html__( 'Home casentino destra', 'icc' ),'id' => 'homecasentinodx','description' => esc_html__( 'Area casentino nella colonna di destra dopo 2 articoli', 'icc' ), 'before_widget' => '<div id="%1$s" class="widget %2$s mt-4">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	}
}
