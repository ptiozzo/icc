			...
			<ul>
				<li>
					<div class="box">
						...
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-abitare/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						...
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-agricoltura-e-acqua/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						...
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-ambiente/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						...
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-cicli-produttivi-e-rifiuti/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/weather.svg' title='' alt=''>
							</figure>
							<span>Clima</span>
						</div>
						<div class="box-body">
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/disability.svg' title='' alt=''>
							</figure>
						...
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-disabilita/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/economy.svg' title='' alt=''>
							</figure>
							<span>Economia</span>
						</div>
						<div class="box-body">
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/education.svg' title='' alt=''>
							</figure>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/energy.svg' title='' alt=''>
							</figure>
							<span>Energia</span>
						</div>
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-energia/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/business.svg' title='' alt=''>
							</figure>
							<span>Imprenditoria</span>
						</div>
						<div class="box-body">
							<article>
								<p>
							...
							<a href="http://new.italiachecambia.org/visione-2040-imprenditoria/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/information.svg' title='' alt=''>
							</figure>
							<span>Informazione<br> e Comunicazione</span>
						</div>
						<div class="box-body">
							<article>
								<p>
							...
							<a href="http://new.italiachecambia.org/visione-2040-informazione-e-comunicazione/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/work.svg' title='' alt=''>
							</figure>
							<span>Lavoro</span>
						</div>
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-lavoro/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/legality.svg' title='' alt=''>
							</figure>
							<span>Legalità</span>
						</div>
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-legalita/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/mobility.svg' title='' alt=''>
							</figure>
							<span>Mobilità</span>
						</div>
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-mobilita/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/health.svg' title='' alt=''>
							</figure>
							<span>Salute</span>
						</div>
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-salute/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/gender.svg' title='' alt=''>
							</figure>
							<span>Tematiche di Genere</span>
						</div>
						<div class="box-body">
							<article>
								<p>
							...
							<a href="http://new.italiachecambia.org/visione-2040-tematiche-di-genere/" class="stretched-link"></a>
				...
				<li>
					<div class="box">
						<div class="box-head">
							<figure>
								<img src='<?php echo get_template_directory_uri();?>/assets/img/icons/travel.svg' title='' alt=''>
							</figure>
							<span>Viaggiare</span>
						</div>
						<div class="box-body">
							...
							<a href="http://new.italiachecambia.org/visione-2040-viaggiare/" class="stretched-link"></a>
						</div>
					</div>
				</li>
			</ul>
