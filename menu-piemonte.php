<header class="menu_regioni">
  ...
  <nav class="navbar navbar-dark navbar-expand-xl">
   ...
   <a class="navbar-brand text-white" href="/piemonte"><img src='<?php echo get_template_directory_uri();?>/assets/img/modules/piemonte/piemonte.svg' class="d-none d-sm-block" alt='' title=''>
     PIEMONTE CHE CAMBIA
   </a>
   <?php
   wp_nav_menu([
